...
hexSticker::sticker(plt,package = "scored",p_size = 20,s_x = 1,s_y = .8,s_width = 1.4,s_height = 1.2,white_around_sticker = FALSE,h_fill = "white",h_color = "#1b3d6e",p_color = "#1b3d6e")
```
